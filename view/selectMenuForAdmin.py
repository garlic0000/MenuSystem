...
from widget.ui_selectMenuForAdmin import Ui_Dialog_selectMenuForAdmin
...
class SelectMenuForAdmin(QDialog, Ui_Dialog_selectMenuForAdmin):
    # 结束对话框
    ...
    def __init__(self, parent=None):
        ...
        :param parent:
        """
        super(SelectMenuForAdmin, self).__init__(parent)
